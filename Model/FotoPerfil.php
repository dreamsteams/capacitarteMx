<?php namespace Model;
  class FotoPerfil {
    ...
    public function getAllUser(){
        ...
        $fotoPerfil = $datos->Select("SELECT imagenes.ruta AS imagenPortada FROM imagenes JOIN usuarios ON imagenes.id = usuarios.foto_perfil WHERE usuarios.id = $idUser");
    	$datos->Desconectar();
